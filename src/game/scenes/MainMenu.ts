            ...
            default:
                this.add
                    ...
                    .on('pointerdown', () => {
                        ...
                        if (!this.isStarted) {
                            this.newStopTime =
                                this.time.now + Phaser.Math.Between(3000, 9000);
                            this.stopTriggered = false;
                            this.isStarted = true;
        ...
        switch (true) {
            ...
            default:
                if (this.isHeating) {
                    ...
                    if (!this.stopTriggered && this.isStarted && this.time.now >= this.newStopTime) {
                        this.stopTriggered = true;
                        this.isHeating = false;
                    }
                }
